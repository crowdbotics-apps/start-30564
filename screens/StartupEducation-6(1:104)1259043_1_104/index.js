      ...
      <View style={styles.View_1_105}>
        ...
        <View style={styles.View_1_107}>
            ...
            <View style={styles.View_1_110}>
              <View style={styles.View_1_111}>
                ...
                <View style={styles.View_1_117}>
                  <Text style={styles.Text_1_117}>Search course</Text>
                </View>
              </View>
          ...
          <View style={styles.View_1_131}>
            <View style={styles.View_1_132}>
              ...
              <View style={styles.View_1_136}>
                <Text style={styles.Text_1_136}>Hi, Akash 👋</Text>
              </View>
            </View>
            <ImageBackground
              source={{
          ...
          <View style={styles.View_1_149}>
            <TouchableOpacity
              style={styles.TouchableOpacity_1_150}
              onPress={() =>
            ...
            >
              <View style={styles.View_1_151}>
                ...
                <View style={styles.View_1_157}>
                  ...
                  <ImageBackground
                    source={{
                      uri:
                        "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/f61c/7d6d/7dd0b09bffc7b880fddc7d042de3d676"
                    }}
                  ...
                  <ImageBackground
                    source={{
                      uri:
                        "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/d047/b178/5670f579e9570de55e319a1c28832bd1"
                    }}
                ...
                <ImageBackground
                  source={{
                    uri:
                      "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/5909/3029/f816a6c405396d1c6b8a6ef34d0a6fe6"
                  }}
              ...
              <View style={styles.View_1_185}>
                ...
                <View style={styles.View_1_187}>
                  ...
                  <View style={styles.View_1_189}>
                    ...
                    <ImageBackground
                      source={{
                        uri:
                          "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/6d7d/245d/54fc7d67eed5729217c53974006778e3"
                      }}
                ...
                <ImageBackground
                  source={{
                    uri:
                      "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/f809/7cd3/bea6c80ead5fc3a694ff99c7589ce37c"
                  }}
            ...
            <View style={styles.View_1_208}>
              <View style={styles.View_1_209}>
                <Text style={styles.Text_1_209}>My Courses</Text>
              </View>
              <View style={styles.View_1_210}>
                <Text style={styles.Text_1_210}>View All</Text>
              </View>
            </View>
          </View>
          <View style={styles.View_1_211}>
            <View style={styles.View_1_212}>
              <Text style={styles.Text_1_212}>Courses by Mentors</Text>
            </View>
            <TouchableOpacity
              style={styles.TouchableOpacity_1_213}
              onPress={() =>
                ...
                <View style={styles.View_1_216}>
                  ...
                  <View style={styles.View_1_218}>
                    <View style={styles.View_1_219}>
                      <Text style={styles.Text_1_219}>Ankur Warikoo</Text>
                    </View>
                    <View style={styles.View_1_220}>
                      <Text style={styles.Text_1_220}>
                ...
                <View style={styles.View_1_223}>
                  ...
                  <View style={styles.View_1_225}>
                    <View style={styles.View_1_226}>
                      <Text style={styles.Text_1_226}>Kunal Shah</Text>
                    </View>
                    <View style={styles.View_1_227}>
                      <Text style={styles.Text_1_227}>Founder CRED</Text>
                    </View>
                  </View>
                </View>
              </View>
