        ...
        <View style={styles.View_1_232}>
            ...
            <View style={styles.View_1_235}>
              <View style={styles.View_1_236}>
                ...
                <View style={styles.View_1_242}>
                  <Text style={styles.Text_1_242}>Search course</Text>
                </View>
              </View>
          ...
          <View style={styles.View_1_256}>
            <View style={styles.View_1_257}>
              <TouchableOpacity
                style={styles.TouchableOpacity_1_258}
                onPress={() =>
              ...
              <View style={styles.View_1_261}>
                <Text style={styles.Text_1_261}>Hi, Akash 👋</Text>
              </View>
            </View>
            <ImageBackground
              source={{
          ...
          <View style={styles.View_1_274}>
            ...
            >
              <View style={styles.View_1_276}>
                ...
                <View style={styles.View_1_282}>
                  ...
                  <ImageBackground
                    source={{
                      uri:
                        "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/2df2/042c/cb595de55eb49c1a21a4f79fba68e476"
                    }}
                  ...
                  <ImageBackground
                    source={{
                      uri:
                        "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/b16d/03db/7dfc0b19c0bb7fb518bbc9a4005f4030"
                    }}
              ...
              <View style={styles.View_1_310}>
                    ...
                    <View style={styles.View_1_316}>
                      <View style={styles.View_1_317}>
                        ...
                        <ImageBackground
                          source={{
                            uri:
                              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/ee74/12ca/a1df13c7a3036308b36fb6505ac23f31"
                          }}
                ...
                <ImageBackground
                  source={{
                    uri:
                      "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/16dc/f3bf/641b381d9af981615b00e1ad495f7b94"
                  }}
            ...
            <View style={styles.View_1_333}>
              <View style={styles.View_1_334}>
                <Text style={styles.Text_1_334}>My Courses</Text>
              </View>
              <View style={styles.View_1_335}>
                <Text style={styles.Text_1_335}>View All</Text>
              </View>
            </View>
          </View>
          <View style={styles.View_1_336}>
            <View style={styles.View_1_337}>
              <Text style={styles.Text_1_337}>Courses by Mentors</Text>
            </View>
            <TouchableOpacity
              style={styles.TouchableOpacity_1_338}
              onPress={() =>
                ...
                <View style={styles.View_1_341}>
                  ...
                  <View style={styles.View_1_343}>
                    <View style={styles.View_1_344}>
                      <Text style={styles.Text_1_344}>Ankur Warikoo</Text>
                    </View>
                    <View style={styles.View_1_345}>
                      <Text style={styles.Text_1_345}>
              ...
              <View style={styles.View_1_346}>
                ...
                <View style={styles.View_1_348}>
                  <ImageBackground
                    ...
                    style={styles.ImageBackground_1_349}
                  />
                  <View style={styles.View_1_350}>
                    <View style={styles.View_1_351}>
                      <Text style={styles.Text_1_351}>Kunal Shah</Text>
                    </View>
                    <View style={styles.View_1_352}>
                      <Text style={styles.Text_1_352}>Founder CRED</Text>
                    </View>
                  </View>
                </View>
              </View>
...
const styles = StyleSheet.create({
  ...
  View_1_230: {
    width: wp("173.67149758454104%"),
    minWidth: wp("173.67149758454104%"),
